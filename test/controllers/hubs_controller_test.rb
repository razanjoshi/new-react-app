...
class HubsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hub" do
    assert_difference('Hub.count') do
      post hubs_url, params: { hub: { active: @hub.active, hub_number: @hub.hub_number, inactive: @hub.inactive } }
    end
  ...
  test "should update hub" do
    patch hub_url(@hub), params: { hub: { active: @hub.active, hub_number: @hub.hub_number, inactive: @hub.inactive } }
